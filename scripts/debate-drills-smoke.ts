...
async function main() {
  ...
  //
  {
    ...
    assert.equal(frozenIds.size, 180, "CF-6b. frozen count is pinned");
    assert.equal(debtIds.size, 7, "CF-6c. known-unbaselined count is pinned");
