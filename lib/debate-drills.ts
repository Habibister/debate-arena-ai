...
export const DRILL_BANK: DrillQuestion[] = [
  ...
  { id: "rb-14", area: "rebuttal", question: "A link turn and an impact turn differ in that a link turn attacks:", choices: ["Whether their plan causes the outcome, while an impact turn attacks whether that outcome is bad", "The author of their evidence, while an impact turn attacks its date", "Their delivery, while an impact turn attacks their logic", "Nothing — the two terms mean the same thing"], correctAnswer: "Whether their plan causes the outcome, while an impact turn attacks whether that outcome is bad", explanation: "A link turn says their mechanism produces the opposite result. An impact turn grants the result and argues it is good. They attack different links in the chain." },
  { id: "rb-15", area: "rebuttal", question: "Running a link turn AND an impact turn against the same argument is dangerous because together they claim:", choices: ["That their plan does not cause the outcome, and also that the outcome is good", "That the outcome is bad, and also that it is unlikely", "More responses than the speech time allows", "That your own evidence is unreliable"], correctAnswer: "That their plan does not cause the outcome, and also that the outcome is good", explanation: "This is the double turn: you end up arguing their plan prevents something good, which hands them offense. Pick one turn and stay with it." },
  { id: "rb-16", area: "rebuttal", question: "Indicting an opponent's evidence differs from turning their argument because an indict:", choices: ["Weakens the argument, while a turn makes it work for your side", "Is always the stronger of the two responses", "Requires you to read new evidence of your own", "May only be used in the final speech"], correctAnswer: "Weakens the argument, while a turn makes it work for your side", explanation: "An indict is defense — it lowers the argument's weight. A turn is offense — it converts the argument into a reason to vote for you." },
  { id: "rb-17", area: "rebuttal", question: "Against one argument you have time for either a defensive answer or an offensive one. Usually prefer the:", choices: ["Offensive answer, because it also gives the judge a reason to vote for you", "Defensive answer, because creating doubt is always safer", "Shorter of the two, to save time for other arguments", "One your partner has already written out"], correctAnswer: "Offensive answer, because it also gives the judge a reason to vote for you", explanation: "With limited time, an answer that both blunts their argument and generates offense does two jobs. Defense alone leaves the judge with nothing affirmative from you." },
  { id: "rb-18", area: "rebuttal", question: "An opponent claims a policy cut crime because crime fell after it passed. The strongest rebuttal is to:", choices: ["Show another factor that better explains the drop over the same period", "State that correlation is not causation and move on", "Point out that the policy is unpopular with voters", "Argue that crime rates are not important to this round"], correctAnswer: "Show another factor that better explains the drop over the same period", explanation: "Naming the fallacy is not yet an answer. Supplying a rival explanation is what actually breaks the causal link the judge is being asked to accept." },
  ...
  { id: "rb-20", area: "rebuttal", question: "A counterexample rebuts a general claim by:", choices: ["Presenting a real case the claim says should not exist", "Listing more examples that support the claim", "Restating the claim in your own words", "Questioning the motives of the person making it"], correctAnswer: "Presenting a real case the claim says should not exist", explanation: "One genuine case that the claim rules out shows the generalisation is not reliable. It attacks the scope of the claim rather than its author." },
  ...
  { id: "rb-25", area: "rebuttal", question: "Their evidence says 40% of firms cut HOURS, but their claim is that firms cut JOBS. The sharpest rebuttal is:", choices: ["Their evidence does not support the claim they are actually making", "Forty percent is a very large proportion", "Their source comes from a university", "You should read your own evidence on the topic instead"], correctAnswer: "Their evidence does not support the claim they are actually making", explanation: "The mismatch between what the card says and what it is being used to prove is the fastest kill: the argument is unsupported even if the study is excellent." },
  ...
  { id: "rb-30", area: "rebuttal", question: "A rebuttal speech made up entirely of defensive answers risks:", choices: ["Leaving the judge with no affirmative reason to vote for you", "Finishing noticeably under the time limit", "Violating a speaking rule of the format", "Conceding every one of the opponent's impacts"], correctAnswer: "Leaving the judge with no affirmative reason to vote for you", explanation: "Doubt about their case is not the same as a reason to prefer yours. A speech needs at least some offense for the judge to have something to vote on." },
