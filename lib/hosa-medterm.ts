...
export const MEDTERM_BANK: MedTermQuestion[] = [
  ...
  { id: "sf-18", area: "suffixes", question: "Which suffix means 'fear of'?", choices: ["-phobia", "-philia", "-mania", "-pathy"], correctAnswer: "-phobia", explanation: "'-phobia' means an abnormal fear (photophobia). '-philia' is attraction to, '-mania' is excessive preoccupation, '-pathy' is disease." },
  ...
  { id: "sf-27", area: "suffixes", question: "The suffix '-osis' means:", choices: ["Abnormal condition", "Inflammation", "Surgical removal", "Enlargement"], correctAnswer: "Abnormal condition", explanation: "'-osis' means an abnormal condition or increase (cyanosis). '-itis' means inflammation specifically." },
  ...
  { id: "sf-29", area: "suffixes", question: "The suffix '-penia' indicates:", choices: ["Deficiency", "Excess", "Hardening", "Formation"], correctAnswer: "Deficiency", explanation: "'-penia' means a deficiency or too few (leukopenia = too few white blood cells). '-osis' can indicate an abnormal increase." },
