...
export const MEDTERM_BANK: MedTermQuestion[] = [
  ...
  { id: "ph-10", area: "physiology", question: "During ventricular systole, the heart normally:", choices: ["Contracts and ejects blood into the arteries", "Relaxes and fills with returning blood", "Stops all electrical activity briefly", "Reverses blood flow into the atria"], correctAnswer: "Contracts and ejects blood into the arteries", explanation: "Systole is the contraction phase: the ventricles squeeze and push blood into the aorta and pulmonary artery. Filling happens during diastole, the relaxation phase." },
  { id: "ph-11", area: "physiology", question: "In the normal cardiac conduction sequence, the impulse leaves the SA node and travels next to the:", choices: ["AV node", "Purkinje fibers", "Left bundle branch", "Aorta"], correctAnswer: "AV node", explanation: "Normal conduction runs SA node to AV node, then down the bundle of His to the bundle branches and Purkinje fibers. The aorta is a vessel and carries no impulse." },
  ...
  { id: "ph-15", area: "physiology", question: "In the alveoli, oxygen normally moves into the blood by:", choices: ["Diffusion down a concentration gradient", "Active transport requiring ATP", "Filtration under arterial pressure", "Peristaltic pumping"], correctAnswer: "Diffusion down a concentration gradient", explanation: "Gas exchange is passive diffusion: oxygen moves from higher concentration in the alveoli to lower concentration in the capillary blood, and carbon dioxide moves the other way." },
  { id: "ph-16", area: "physiology", question: "The strongest normal stimulus that increases the rate and depth of breathing is a rise in blood:", choices: ["Carbon dioxide", "Calcium", "Glucose", "Protein"], correctAnswer: "Carbon dioxide", explanation: "Chemoreceptors respond mainly to rising carbon dioxide (and the resulting drop in pH). Low oxygen is a much weaker everyday driver of breathing." },
  { id: "ph-17", area: "physiology", question: "The primary normal function of the small intestine is to:", choices: ["Absorb nutrients into the bloodstream", "Store bile until a meal", "Reabsorb most of the water from waste", "Produce digestive hormones only"], correctAnswer: "Absorb nutrients into the bloodstream", explanation: "Most chemical digestion finishes and most nutrient absorption happens in the small intestine. Bile is stored in the gallbladder; most water reabsorption happens in the large intestine." },
  ...
  { id: "ph-24", area: "physiology", question: "A nerve impulse normally crosses a synapse when the sending neuron:", choices: ["Releases a neurotransmitter into the gap", "Touches the next neuron directly", "Sends part of its cell body across", "Pumps blood toward the next neuron"], correctAnswer: "Releases a neurotransmitter into the gap", explanation: "Neurons do not touch. The arriving impulse triggers chemical neurotransmitter release, which binds receptors on the next cell and passes the signal along." },
  { id: "ph-25", area: "physiology", question: "Sympathetic nervous activity normally prepares the body for exertion by:", choices: ["Raising heart rate and shifting blood toward skeletal muscle", "Slowing the heart and increasing digestive activity", "Producing antibodies against infection", "Increasing urine production"], correctAnswer: "Raising heart rate and shifting blood toward skeletal muscle", explanation: "The sympathetic division drives the \"fight or flight\" pattern. The parasympathetic division does the opposite, slowing the heart and favouring digestion." },
  { id: "ph-26", area: "physiology", question: "Skeletal muscle contraction normally begins when:", choices: ["Calcium is released inside the fiber, letting the filaments slide", "Lactic acid accumulates in the fiber", "The bone shortens and pulls on the muscle", "Oxygen leaves the muscle cell"], correctAnswer: "Calcium is released inside the fiber, letting the filaments slide", explanation: "A motor nerve signal releases stored calcium, which exposes binding sites so actin and myosin filaments slide past each other and the fiber shortens." },
