...
// Record ONE answer to a served DECA concept-drill question and return its feedback (M13E2 C2).
//
...
//
// DELIBERATELY NOT RATE-LIMITED. The existing `light` tier is 20 requests/minute, and a long session
// legitimately needs one call per question plus a start and a submit — limiting it would break
