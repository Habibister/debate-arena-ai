 ...
 *
 * The catalog holds 20 entries (B2.1 added debate-answer-types). At S1B-LC1 only 4 of the then-17 were published through the education
 ...
 */
const LEARNING_CONTENT_BASELINE = "B21-DEBATE-ANSWER-TYPES-TEACHING";
...
async function main(): Promise<void> {
  ...
  console.log(
    ...
    `catalog entries — 8 published through the education registry and 12 held — are byte-for-byte identical to the ` +
