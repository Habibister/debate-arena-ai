...
export const MEDTERM_BANK: MedTermQuestion[] = [
  ...
  { id: "pp-10", area: "pathophysiology", question: "The redness and warmth of acutely inflamed tissue are produced mainly by:", choices: ["Increased blood flow to the injured area", "Loss of blood supply to the injured area", "Cooling of the tissue surface", "Thickening of the outer skin layer"], correctAnswer: "Increased blood flow to the injured area", explanation: "Inflammatory mediators dilate local vessels, so more warm blood reaches the site. That extra flow is what makes the area look red and feel hot." },
  ...
  { id: "pp-14", area: "pathophysiology", question: "Immunodeficiency raises infection risk because the body:", choices: ["Cannot mount an adequate immune response", "Attacks its own tissue by mistake", "Reacts too strongly to harmless substances", "Produces too many red blood cells"], correctAnswer: "Cannot mount an adequate immune response", explanation: "In immunodeficiency the defence is too weak, so ordinary organisms cause serious illness. Autoimmunity and allergy are the opposite problem — a response that is misdirected or excessive." },
  { id: "pp-15", area: "pathophysiology", question: "In atherosclerosis, the arterial change that restricts blood flow is:", choices: ["Plaque buildup that narrows the vessel lumen", "Excess fluid collecting outside the vessel", "Loss of red blood cells from the blood", "An increase in vessel wall elasticity"], correctAnswer: "Plaque buildup that narrows the vessel lumen", explanation: "Fatty plaque accumulates within the arterial wall and progressively narrows and stiffens the lumen, so less blood reaches the tissue beyond it." },
  { id: "pp-16", area: "pathophysiology", question: "A thrombus and an embolus differ in that an embolus:", choices: ["Has travelled from where it formed and lodged elsewhere", "Stays permanently at the site where it formed", "Can only form inside the heart", "Dissolves on its own within minutes"], correctAnswer: "Has travelled from where it formed and lodged elsewhere", explanation: "A thrombus stays at its site of formation. An embolus is material that has broken away and travelled through the circulation until it obstructs a smaller vessel." },
  { id: "pp-17", area: "pathophysiology", question: "A very fast or irregular heart rhythm can lower cardiac output because:", choices: ["The ventricles have too little time to fill between beats", "The blood loses its ability to carry oxygen", "The arteries can no longer carry any blood", "The lungs stop taking in air"], correctAnswer: "The ventricles have too little time to fill between beats", explanation: "Output depends on how much blood each beat ejects. If filling time is cut short, stroke volume falls, and the faster rate does not make up the difference." },
  { id: "pp-18", area: "pathophysiology", question: "In heart failure, symptoms arise mainly because the heart:", choices: ["Cannot pump enough blood to meet the body's demands", "Produces too many red blood cells", "Loses all electrical conduction permanently", "Fills with air instead of blood"], correctAnswer: "Cannot pump enough blood to meet the body's demands", explanation: "Heart failure is a pumping deficit: forward flow is inadequate for the tissues, and blood tends to back up behind the failing side of the heart." },
  ...
  { id: "pp-20", area: "pathophysiology", question: "If the lungs cannot clear carbon dioxide adequately, blood pH:", choices: ["Falls, producing acidosis", "Rises, producing alkalosis", "Stays exactly the same", "Becomes permanently neutral"], correctAnswer: "Falls, producing acidosis", explanation: "Retained carbon dioxide combines with water to form carbonic acid, raising hydrogen ion concentration and driving pH downward." },
  ...
  { id: "pp-23", area: "pathophysiology", question: "Severe dehydration lowers blood pressure mainly because:", choices: ["Circulating blood volume falls", "The heart loses its electrical conduction", "Red blood cells stop carrying oxygen", "Arteries become excessively elastic"], correctAnswer: "Circulating blood volume falls", explanation: "Losing body water reduces plasma volume, so less blood returns to the heart, each beat ejects less, and arterial pressure drops." },
  ...
  { id: "pp-25", area: "pathophysiology", question: "Unlike a benign tumor, a malignant tumor characteristically:", choices: ["Invades nearby tissue and can spread to distant sites", "Grows more slowly in every case", "Is always physically smaller", "Never needs any monitoring"], correctAnswer: "Invades nearby tissue and can spread to distant sites", explanation: "Invasion of surrounding tissue and spread to distant sites are the defining behaviours of malignancy; size and growth rate alone do not separate the two." },
  { id: "pp-26", area: "pathophysiology", question: "Necrosis differs from the body's normal programmed cell death because necrosis:", choices: ["Is uncontrolled, injury-driven death that provokes inflammation", "Is an orderly process that recycles worn-out cells", "Occurs only during normal growth and development", "Happens without any cell injury at all"], correctAnswer: "Is uncontrolled, injury-driven death that provokes inflammation", explanation: "Programmed cell death is tidy and routine. Necrosis follows injury: cells rupture and spill their contents, and the surrounding tissue becomes inflamed." },
  { id: "pp-27", area: "pathophysiology", question: "Muscle atrophy after prolonged immobility occurs because the tissue:", choices: ["Loses mass when it is no longer being used", "Gains extra cells to compensate", "Enlarges each of its existing cells", "Is gradually replaced by bone"], correctAnswer: "Loses mass when it is no longer being used", explanation: "Atrophy is a decrease in tissue mass from disuse, poor nutrition or lost nerve supply — the opposite adaptation to hypertrophy." },
  { id: "pp-28", area: "pathophysiology", question: "Hypertrophy and hyperplasia differ in that hypertrophy is an increase in:", choices: ["The size of existing cells, not their number", "The number of cells, not their size", "The fluid held between the cells", "Blood flow to the tissue only"], correctAnswer: "The size of existing cells, not their number", explanation: "Hypertrophy enlarges existing cells; hyperplasia raises the cell count. Both increase tissue bulk, so the distinction is which change produced it." },
  ...
  { id: "pp-30", area: "pathophysiology", question: "A person may carry bacteria without being ill. Infection is distinguished from harmless colonization when the organism:", choices: ["Invades tissue and causes damage or symptoms", "Is present anywhere on the skin", "Can be grown in a laboratory", "Is a bacterium rather than a virus"], correctAnswer: "Invades tissue and causes damage or symptoms", explanation: "Colonization means the organism is merely present. Infection means it has invaded tissue and provoked damage or a host response that produces illness." },
];
