...
export const MEDTERM_BANK: MedTermQuestion[] = [
  ...
  { id: "pp-18", area: "pathophysiology", question: "In heart failure, symptoms arise mainly because the heart:", choices: ["Cannot fill and pump effectively enough to maintain adequate circulation", "Produces too many red blood cells", "Loses all electrical conduction permanently", "Fills with air instead of blood"], correctAnswer: "Cannot fill and pump effectively enough to maintain adequate circulation", explanation: "Heart failure can follow impaired contraction, impaired relaxation and filling, or both. Forward flow becomes inadequate and filling pressures can rise, causing symptoms and congestion. The heart has not stopped." },
  ...
  { id: "pp-28", area: "pathophysiology", question: "When muscle tissue is exposed to a chronically increased workload, it may thicken mainly because:", choices: ["Existing muscle cells increase in size", "The number of muscle cells increases", "Fluid accumulates between the cells", "The cells are gradually replaced by bone"], correctAnswer: "Existing muscle cells increase in size", explanation: "Enlargement of existing cells is hypertrophy; an increase in cell number is hyperplasia. Hypertrophy is a common adaptation to sustained workload, and it can occur in normal settings or in disease — this item tests the chronic-overload mechanism." },
