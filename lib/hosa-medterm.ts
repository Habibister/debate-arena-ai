...
export const MEDTERM_BANK: MedTermQuestion[] = [
  ...
  { id: "an-24", area: "anatomy", question: "The cerebellum is located:", choices: ["Beneath the cerebrum at the back of the skull", "In front of the cerebrum", "Within the spinal canal", "Above the cerebrum"], correctAnswer: "Beneath the cerebrum at the back of the skull", explanation: "The cerebellum sits below and behind the cerebrum, at the base of the skull." },
  { id: "an-25", area: "anatomy", question: "The largest artery in the body is the:", choices: ["Aorta", "Carotid", "Femoral artery", "Pulmonary vein"], correctAnswer: "Aorta", explanation: "The aorta is the body's largest artery, leaving the left ventricle. The pulmonary vein is not an artery at all." },
  ...
  { id: "an-30", area: "anatomy", question: "The largest muscle in the human body is the:", choices: ["Gluteus maximus", "Biceps brachii", "Diaphragm", "Sartorius"], correctAnswer: "Gluteus maximus", explanation: "The gluteus maximus, in the buttock, is the body's largest muscle by mass." },
