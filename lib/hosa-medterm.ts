...
export const MEDTERM_BANK: MedTermQuestion[] = [
  ...
  { id: "wr-10", area: "word-roots", question: "A term built on 'my' (as in myalgia) concerns which tissue?", choices: ["Muscle", "Bone", "Nerve", "Skin"], correctAnswer: "Muscle", explanation: "'My'/'myo' means muscle (myalgia = muscle pain; myocardium = heart muscle). 'Oste' is bone, 'neur' is nerve, 'derm' is skin." },
  { id: "wr-11", area: "word-roots", question: "The root 'cerebr' refers to the:", choices: ["Brain", "Heart", "Ribs", "Bladder"], correctAnswer: "Brain", explanation: "'Cerebr' means brain (cerebral, cerebrovascular). 'Cardi' is heart, 'cost' is rib, 'cyst' is bladder/sac." },
  ...
  { id: "wr-25", area: "word-roots", question: "A word built on 'enter' concerns the:", choices: ["Small intestine", "Stomach", "Colon", "Esophagus"], correctAnswer: "Small intestine", explanation: "'Enter' means small intestine (enteritis; gastroenteritis). 'Gastr' is stomach, 'col' is colon, 'esophag' is esophagus." },
  { id: "wr-26", area: "word-roots", question: "The root 'col' (as in colonoscopy) refers to the:", choices: ["Large intestine", "Small intestine", "Gallbladder", "Kidney"], correctAnswer: "Large intestine", explanation: "'Col'/'colon' means the large intestine (colonoscopy, colitis). 'Enter' is the small intestine." },
  ...
  { id: "wr-29", area: "word-roots", question: "A term containing 'lip' (as in lipid) concerns:", choices: ["Fat", "Lips", "Lymph", "Liver"], correctAnswer: "Fat", explanation: "'Lip' means fat (lipid, liposuction). Despite the spelling it does not refer to the lips; 'hepat' is liver." },
