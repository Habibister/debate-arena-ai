...
async function main() {
  ...
  assert.deepEqual(debateIds,
    ...
    "26. the index lists the ten real Debate lessons in teaching order (B2.2 added turn-mechanics)");
  ...
  assert.equal(EDUCATION_LESSONS.length, 12, "28. exactly twelve canonical lessons after B2.2");
