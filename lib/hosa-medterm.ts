...
export const MEDTERM_BANK: MedTermQuestion[] = [
  ...
  // M14 Phase 2f (audit G2): pathophysiology extended 9 -> 30, the SIXTH and last HOSA area taken to
  // depth. This completes the HOSA portion of G2 ONLY — the audit's G2 finding also covers four
  // Debate areas and four DECA areas still at 9 each, so G2 itself remains OPEN. Do not record this
  // slice as closing G2.
  // AUTHORING BOUNDARY: every item below tests an ABNORMAL process — what is going wrong, how the
  // disease alters normal function, or the consequence of that abnormal mechanism. None is a
  // structure's location (`anatomy`), a normal function (`physiology`), a word-part recall item
  // (`word-roots`/`prefixes`/`suffixes`), diagnostic instruction, treatment advice or clinical
  // management. The nine legacy items are definition-heavy; they stay unchanged, but the additions
  ...
  { id: "pp-13", area: "pathophysiology", question: "An allergic reaction is best understood as an immune response that is:", choices: ["Exaggerated toward a normally harmless substance", "Directed at the body's own healthy tissue", "Too weak to clear an ordinary infection", "Limited to bacterial invaders only"], correctAnswer: "Exaggerated toward a normally harmless substance", explanation: "Allergy is hypersensitivity: the response works but is out of proportion, and it is aimed at something harmless such as pollen rather than at self-tissue." },
  { id: "pp-14", area: "pathophysiology", question: "Immunodeficiency raises infection risk because the body:", choices: ["Cannot mount an adequate immune response", "Attacks its own tissue by mistake", "Reacts too strongly to harmless substances", "Produces too many red blood cells"], correctAnswer: "Cannot mount an adequate immune response", explanation: "With defences weakened, infections can be more frequent, more severe or harder to clear — including ones an intact immune system would normally control. Autoimmunity and allergy are the opposite problem: a response that is misdirected or excessive." },
  { id: "pp-15", area: "pathophysiology", question: "In atherosclerosis, the arterial change that restricts blood flow is:", choices: ["Plaque buildup that narrows the vessel lumen", "Excess fluid collecting outside the vessel", "Loss of red blood cells from the blood", "An increase in vessel wall elasticity"], correctAnswer: "Plaque buildup that narrows the vessel lumen", explanation: "Fatty plaque accumulates within the arterial wall, narrowing the lumen it encloses. Wall changes can also make the artery less compliant, and the narrowing can reduce blood flow downstream." },
  { id: "pp-16", area: "pathophysiology", question: "A thrombus and an embolus differ in that an embolus:", choices: ["Travels through the circulation and lodges away from its origin", "Stays permanently at the site where it formed", "Can only arise inside the heart", "Dissolves on its own within minutes"], correctAnswer: "Travels through the circulation and lodges away from its origin", explanation: "A thrombus is a clot that forms and stays at its site of formation. An embolus is material carried in the bloodstream that lodges elsewhere. A detached thrombus becomes a thromboembolus, but other embolic material exists too." },
  { id: "pp-17", area: "pathophysiology", question: "A very fast or irregular heart rhythm can lower cardiac output because:", choices: ["The ventricles have too little time to fill between beats", "The blood loses its ability to carry oxygen", "The arteries can no longer carry any blood", "The lungs stop taking in air"], correctAnswer: "The ventricles have too little time to fill between beats", explanation: "A sufficiently rapid rhythm shortens ventricular filling, so stroke volume can fall. Output drops only if that fall outweighs the faster rate — a moderate rise in heart rate does not automatically reduce cardiac output." },
  { id: "pp-18", area: "pathophysiology", question: "In heart failure, symptoms arise mainly because the heart:", choices: ["Cannot fill or pump effectively enough to maintain adequate circulation", "Produces too many red blood cells", "Loses all electrical conduction permanently", "Fills with air instead of blood"], correctAnswer: "Cannot fill or pump effectively enough to maintain adequate circulation", explanation: "Heart failure can follow impaired contraction, impaired relaxation and filling, or both. Forward flow becomes inadequate and filling pressures can rise, causing symptoms and congestion. The heart has not stopped." },
  { id: "pp-19", area: "pathophysiology", question: "In an obstructive airway disease, breathing is difficult mainly because:", choices: ["Narrowed airways make it hard to move air out", "The blood contains no hemoglobin at all", "The diaphragm is completely paralyzed", "The chest wall has turned to rigid bone"], correctAnswer: "Narrowed airways make it hard to move air out", explanation: "Narrowing, swelling and mucus raise the resistance to airflow. Expiration suffers most, because airways tend to collapse further as the chest empties." },
  { id: "pp-20", area: "pathophysiology", question: "If the lungs cannot clear carbon dioxide adequately, blood pH:", choices: ["Falls, producing respiratory acidosis", "Rises, producing respiratory alkalosis", "Stays exactly the same", "Becomes permanently neutral"], correctAnswer: "Falls, producing respiratory acidosis", explanation: "Retained carbon dioxide combines with water to form carbonic acid, raising hydrogen ion concentration and driving pH down. Because the cause is impaired ventilation, this is called respiratory acidosis; acidosis can also arise from non-respiratory causes." },
  { id: "pp-21", area: "pathophysiology", question: "Fluid or mucus filling the alveoli impairs breathing mainly because it:", choices: ["Blocks gas exchange across the alveolar wall", "Raises the oxygen level inside the alveoli", "Strengthens the diaphragm muscle", "Speeds blood flow through the lungs"], correctAnswer: "Blocks gas exchange across the alveolar wall", explanation: "Gas must diffuse between alveolar air and capillary blood. Anything filling that space lengthens or blocks the path, so less oxygen crosses into the blood." },
  { id: "pp-22", area: "pathophysiology", question: "When kidney filtration is severely impaired, the most direct consequence is:", choices: ["Waste products accumulate in the blood", "The blood loses its ability to clot", "The lungs stop exchanging gases", "Bile production in the liver stops"], correctAnswer: "Waste products accumulate in the blood", explanation: "The kidneys clear nitrogenous waste and regulate fluid and electrolytes. When filtration fails those wastes build up and fluid balance is disturbed." },
  { id: "pp-23", area: "pathophysiology", question: "Severe dehydration can lower blood pressure mainly because:", choices: ["Circulating blood volume falls", "The heart loses its electrical conduction", "Red blood cells stop carrying oxygen", "Arteries become excessively elastic"], correctAnswer: "Circulating blood volume falls", explanation: "Losing body water reduces plasma volume, so less blood returns to the heart and each beat ejects less. A faster heart rate and vasoconstriction can hold pressure up at first; if the loss is severe enough, that compensation becomes inadequate and pressure falls." },
  { id: "pp-24", area: "pathophysiology", question: "Sustained high blood glucose increases urine output mainly because glucose:", choices: ["Pulls water into the urine once reabsorption is exceeded", "Directly damages the wall of the bladder", "Physically blocks both of the ureters", "Stops the body from making any ADH"], correctAnswer: "Pulls water into the urine once reabsorption is exceeded", explanation: "Beyond the tubules' reabsorption capacity, glucose stays in the filtrate and osmotically holds water there, so urine volume rises and thirst follows." },
  { id: "pp-25", area: "pathophysiology", question: "Unlike a benign tumor, a malignant tumor characteristically:", choices: ["Invades nearby tissue and can spread to distant sites", "Grows more slowly in every case", "Is always physically smaller", "Never needs any monitoring"], correctAnswer: "Invades nearby tissue and can spread to distant sites", explanation: "Invasion of surrounding tissue is characteristic of malignancy, and malignant tumors have the capacity to spread to distant sites. Size or growth rate alone does not tell benign and malignant apart." },
  { id: "pp-26", area: "pathophysiology", question: "Necrosis differs from apoptosis because necrosis typically:", choices: ["Is uncontrolled, injury-associated cell death that often provokes inflammation", "Is a regulated process that dismantles a cell tidily", "Occurs only during normal growth and development", "Happens without any cell injury at all"], correctAnswer: "Is uncontrolled, injury-associated cell death that often provokes inflammation", explanation: "Necrosis commonly follows severe cell injury: membrane integrity is lost and the spilled contents trigger inflammation. Apoptosis is regulated, programmed cell death, and it occurs in normal physiology as well as in disease." },
  { id: "pp-27", area: "pathophysiology", question: "Muscle atrophy after prolonged immobility occurs mainly because muscle fibers:", choices: ["Decrease in size as their protein content falls", "Increase in number to compensate", "Enlarge as their protein content rises", "Are gradually replaced by bone"], correctAnswer: "Decrease in size as their protein content falls", explanation: "Atrophy is reduced tissue mass. In disuse skeletal-muscle atrophy the existing fibers mainly become smaller as protein is lost; in some tissues cell number can fall too. Disuse, aging, poor nutrition and lost nerve input can all cause it." },
  { id: "pp-28", area: "pathophysiology", question: "When heart muscle is exposed to chronic abnormal pressure overload, the wall may thicken mainly because:", choices: ["Existing muscle cells increase in size", "The number of muscle cells increases", "Fluid accumulates between the cells", "The cells are gradually replaced by bone"], correctAnswer: "Existing muscle cells increase in size", explanation: "Enlargement of existing cells is hypertrophy; an increase in cell number is hyperplasia. Hypertrophy can occur in normal or in pathological settings — this item concerns the hypertrophy produced by chronic abnormal pressure overload, where the thickened wall itself becomes part of the problem." },
  { id: "pp-29", area: "pathophysiology", question: "Shock differs from a localized loss of blood supply because in shock the inadequate perfusion is:", choices: ["Body-wide, so many tissues are underperfused at once", "Confined to one small area of one organ", "Always caused by bleeding and nothing else", "Present only while the person is asleep"], correctAnswer: "Body-wide, so many tissues are underperfused at once", explanation: "Shock is circulatory failure affecting the whole body, so oxygen delivery falls short in many tissues at once rather than in one localized region." },
  { id: "pp-30", area: "pathophysiology", question: "A person may carry bacteria without being ill. Infection is distinguished from harmless colonization when the organism:", choices: ["Invades and multiplies in host tissue, provoking a host response", "Is present anywhere on the skin", "Can be grown in a laboratory", "Is a bacterium rather than a virus"], correctAnswer: "Invades and multiplies in host tissue, provoking a host response", explanation: "In colonization organisms are present or growing at a site without invading or damaging tissue. In infection they invade and multiply in host tissue and provoke a host response or tissue effects — which may be symptomatic or asymptomatic." },
];
