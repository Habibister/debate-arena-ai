...
async function main() {
  ...
  assert.deepEqual([...INTENDED_SKILL_SLUGS].filter((s) => practiceRemediationForSkill(s) !== null),
    ["debate-evidence", "debate-rebuttal", "debate-weighing", "deca-marketing", "deca-performance-indicators", "deca-business-reasoning", "deca-customer-relations", "debate-clash"],
    "S2-2. exactly the eight lesson-connected intended skills have a remediation today (clash is activation-pending, listed last)");
  ...
  assert.deepEqual([...INTENDED_SKILL_SLUGS].filter((x) => !x.startsWith("debate-")).filter((s) => practiceRemediationForSkill(s) !== null),
    ["deca-marketing", "deca-performance-indicators", "deca-business-reasoning", "deca-customer-relations"], "S2-4c. and all four DECA skills now resolve — two role-play, two cluster knowledge");
