...
export const MEDTERM_BANK: MedTermQuestion[] = [
  ...
  { id: "pr-20", area: "prefixes", question: "The prefix 'hemi-' means:", choices: ["Half", "Whole", "Double", "Between"], correctAnswer: "Half", explanation: "'Hemi-' means half (hemisphere = half a sphere). 'Semi-' also means half; 'bi-' means two." },
  ...
  { id: "pr-30", area: "prefixes", question: "The prefix 'olig-' means:", choices: ["Few or scanty", "Many", "Large", "Rapid"], correctAnswer: "Few or scanty", explanation: "'Olig-' means few or scanty (oliguria = scanty urine output). 'Poly-' means many." },
