...
export const LEARNING_SKILL_CATALOG: LearningSkillSeed[] = [
  {
    ...
    lesson: {
      ...
      content: lesson(
        ...
        q("What is a debater's real job in a round?", ["Say everything true about the topic that you can fit in", "Show the judge you know more about the subject than they do", "Help the judge see why your side's reasons should win", "Get the other side to admit that their position is wrong"], "Help the judge see why your side's reasons should win", "Think about who decides the round.", "The judge decides between reasons, so every sentence should help them follow and prefer yours. Covering the topic, out-knowing the judge and extracting a concession all aim at someone other than the person who votes.", "Orientation"),
        [
          q("Debate formats vary a great deal from one to another. What does not change?", ["The number of speeches each side is given in the round", "Building your case, answering the other side, and comparing", "The length of time each speaker is allowed to talk", "The names each format uses for its individual speeches"], "Building your case, answering the other side, and comparing", "Ask which part a format can change and which part it cannot.", "Speech counts, timings and names are exactly what formats vary. What no format removes is the work: introduce your side's case, answer what the other side argued, and tell the judge which points should decide it.", "Orientation"),
          q("Which choice gives the judge an actual reason instead of only stating a position?", ["School uniforms are the right policy for almost every school", "Most parents and teachers already support school uniforms", "School uniforms have been debated in districts for years", "Uniforms help because they reduce visible income differences"], "Uniforms help because they reduce visible income differences", "An argument carries a reason the judge can weigh.", "A claim plus a reason gives the judge something to evaluate. Asserting that a policy is right, reporting that people support it, and noting that it gets debated are all statements about the topic that leave the judge with nothing to weigh.", "Orientation"),
          q("The other side just answered one of your arguments. What should you do?", ["Respond to their answer and explain why your point still stands", "Restate your original argument with more supporting detail", "Point out that they answered instead of building their own case", "Move on to your next argument so that you cover more ground"], "Respond to their answer and explain why your point still stands", "An unanswered response usually wins the point.", "Once an argument is answered, the judge needs your reply to the answer. More detail on the original does not address what was said; commenting on their strategy is not a reply either; and moving on leaves their answer standing.", "Orientation")
        ],
        [
          q("Side A says: 'Homework should be limited because students need sleep.' Side B answers: 'Students lose sleep to phones, not homework.' What does the judge most need from Side A next?", ["A new reason to limit homework that does not depend on sleep at all", "A reason why homework still costs sleep worth acting on, even if phones matter too", "Agreement that phones matter too, then a move on to whichever argument is next", "A restatement that students need sleep, this time with a study attached"], "A reason why homework still costs sleep worth acting on, even if phones matter too", "The clash is about the cause — resolve it.", "Side B answered the reason, so the judge needs Side A to engage that answer. Switching to a new reason abandons the contested one, agreeing and moving on concedes it, and adding a study to the original restates a point nobody disputed — Side B never denied that sleep matters.", "Orientation")
        ]
      )
    }
  },
